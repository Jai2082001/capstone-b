...
const jobsListings = require('../controllers/adminlistings');
...
router.get('/displayListings', jobsListings.displayCase);
router.get('/deleteListing', jobsListings.deleteCase);
router.post('/updateListing', jobsListings.updateCase);
router.post('/saveListing', jobsListings.saveCase);
router.get('/detailListing', jobsListings.detailLegal)
